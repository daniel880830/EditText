...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setBackgroundDrawableResource(R.drawable.hedgehog);
    }
    int size=15;
    public void response(View v){
        ...
        txv.setText(ed1.getText().toString()+"Hello"+",n" +"your BMI is"+BMI2);
    ...
    private String standardBMI(double st){
        ...
        if(st>25){
            ...
            getWindow().setBackgroundDrawableResource(R.drawable.catc);
        }else if(st<18.5){
            alert = String.valueOf("You are too slim.");
            getWindow().setBackgroundDrawableResource(R.drawable.catn);
        }else{
